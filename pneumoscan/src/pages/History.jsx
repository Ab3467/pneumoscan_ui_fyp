...
import { Calendar, AlertCircle, CheckCircle, ChevronRight, Activity, Search, Filter, Download, Trash2, LogOut } from "lucide-react";
...
export default function History() {
  ...
  const fetchHistory = async () => {
    try {
      ...
      console.log("🔍 History fetch - Token from localStorage:", token ? "EXISTS" : "MISSING");
      ...
      console.error("🔍 Error in fetchHistory:", err.message);
              ...
              {error.toLowerCase().includes("invalid token") ? (
                <>
                  <button
                    ...
                    className="inline-flex items-center justify-center px-4 py-2 bg-red-600 text-white rounded-xl font-medium hover:bg-red-700"
                  >
